 ...
 */
public class AutomatikoInterfaceImportDialog extends DefaultSchemaImportDialog {

	boolean createVariables = false;
	CheckboxTableViewer methodsTable;
	IMethod[] selectedMethods = new IMethod[0];
	
	public AutomatikoInterfaceImportDialog() {
	...
	public Control createDialogArea(Composite parent) {
		...
		label.setText( Messages.AutomatikoInterfaceImportDialog_Available_Methods);
		...
		selectAllButton.setText(Messages.AutomatikoInterfaceImportDialog_Select_All);
		...
		selectNoneButton.setText(Messages.AutomatikoInterfaceImportDialog_Select_None);
		...
		createVariablesbutton.setText(Messages.AutomatikoImportDialog_Create_Process_Variables_Label);
