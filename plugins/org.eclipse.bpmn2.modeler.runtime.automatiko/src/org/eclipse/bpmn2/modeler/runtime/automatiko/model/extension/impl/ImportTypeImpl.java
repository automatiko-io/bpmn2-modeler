 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.automatiko.model.extension.impl.ImportTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportTypeImpl extends EObjectImpl implements ImportType {
	...
	protected EClass eStaticClass() {
		return ExtensionPackage.Literals.IMPORT_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.IMPORT_TYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionPackage.IMPORT_TYPE__NAME:
				return getName();
		}
