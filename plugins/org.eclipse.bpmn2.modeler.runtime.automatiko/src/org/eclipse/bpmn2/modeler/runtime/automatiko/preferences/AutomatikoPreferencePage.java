...
public class AutomatikoPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	
	public final static String PREF_ENABLE_SIMULATION_PARAMS = "enable.simulation.params"; //$NON-NLS-1$
	public final static String PREF_ENABLE_SIMULATION_PARAMS_LABEL = Messages.AutomatikoPreferencePage_Enable_Simulation;

	public AutomatikoPreferencePage() {
		super(GRID);
		Bpmn2Preferences.getInstance();
		setPreferenceStore(Activator.getDefault().getPreferenceStore());
		setDescription(Messages.AutomatikoPreferencePage_JBPM_Settings);
	}
