...
public class AutomatikoDataAssociationPropertiesAdapter extends
		DataAssociationPropertiesAdapter {

	public AutomatikoDataAssociationPropertiesAdapter(AdapterFactory adapterFactory,
    	...
    	setFeatureDescriptor(ref, new AutomatikoSourceTargetFeatureDescriptor(this,object,ref) {
	...
	public class AutomatikoSourceTargetFeatureDescriptor extends SourceTargetFeatureDescriptor {

		public AutomatikoSourceTargetFeatureDescriptor(ExtendedPropertiesAdapter<DataAssociation> owner,
