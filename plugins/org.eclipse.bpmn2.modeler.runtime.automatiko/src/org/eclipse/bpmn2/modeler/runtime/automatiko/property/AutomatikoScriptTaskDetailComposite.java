 ...
 *
 */
public class AutomatikoScriptTaskDetailComposite extends AutomatikoTaskDetailComposite {
	 ...
	 * @param section
	 */
	public AutomatikoScriptTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoScriptTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
	...
	public void createBindings(EObject be) {
		...
		scriptFormatEditor.createControl(getAttributesParent(),Messages.AutomatikoScriptTaskDetailComposite_Script_Language);
		...
		bindAttribute(be,Messages.AutomatikoScriptTaskDetailComposite_8);
	}
}
