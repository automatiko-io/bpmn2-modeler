 ...
 *
 */
public class AutomatikoDescriptionPropertySection extends DescriptionPropertySection {
	...
	class MetaDataTable extends ExtensionValueListComposite {
		...
		protected EObject addListItem(EObject object, EStructuralFeature feature) {
			...
			MetaDataType newData = ExtensionFactory.eINSTANCE.createMetaDataType();
			MetaValueType newValue = ExtensionFactory.eINSTANCE.createMetaValueType();
			newValue.setValue("");
			...
			LifecycleEvent.notify(EventType.BUSINESSOBJECT_CREATED, newData, rt);
			...
			AbstractDetailComposite detailComposite = new DefaultDetailComposite(parent, style) {
				...
				public void createBindings(EObject be) {
					...
					if (be instanceof MetaDataType) {
						...
						MetaValueType metaValue = metaData.getMetaValue();
						ObjectEditor editor = new TextObjectEditor(this,metaValue,ExtensionPackage.eINSTANCE.getMetaValueType_Value());
	...
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikoDescriptionPropertyComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		return new AutomatikoDescriptionPropertyComposite(parent, style);
	}

	public AutomatikoDescriptionPropertySection() {
		super();
	}

	public class AutomatikoDescriptionPropertyComposite extends DescriptionDetailComposite {

		public AutomatikoDescriptionPropertyComposite(AbstractBpmn2PropertySection section) {
			super(section);
		}

		public AutomatikoDescriptionPropertyComposite(Composite parent, int style) {
			super(parent, style);
		}
		...
		public void createBindings(final EObject be) {
			...
			if (process == null) {
				...
				// AutomatikoDataItemsDetailComposite
		...
		protected void bindMetaDataTable(final BaseElement be) {
			...
			metaDataTable.setTitle(Messages.AutomatikoDescriptionPropertySection_MetaData_Section_Title);
