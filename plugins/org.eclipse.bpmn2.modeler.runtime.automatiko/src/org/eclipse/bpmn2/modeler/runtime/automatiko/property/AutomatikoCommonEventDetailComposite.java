 ...
 *
 */
public class AutomatikoCommonEventDetailComposite extends CommonEventDetailComposite {

	/**
	 * @param parent
	 * @param style
	 */
	public AutomatikoCommonEventDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
	 ...
	 * @param section
	 */
	public AutomatikoCommonEventDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	...
	protected AbstractListComposite bindList(final EObject object, EStructuralFeature feature, EClass listItemClass) {
		if (isModelObjectEnabled(object.eClass(), feature)) {
			if ("eventDefinitions".equals(feature.getName())) { //$NON-NLS-1$
				eventsTable = new EventDefinitionsListComposite(this, (Event)object) {
					...
					public AbstractDetailComposite createDetailComposite(Class eClass, Composite parent, int style) {
						if (eClass==TimerEventDefinition.class) {
							return new AutomatikoTimerEventDefinitionDetailComposite(parent, style);
						}
					...
					protected EObject addListItem(EObject object, EStructuralFeature feature) {
						...
						if (eventDefinitions.size()>0) {
							MessageDialog.openError(getShell(), Messages.AutomatikoCommonEventDetailComposite_Error_Title,
								Messages.AutomatikoCommonEventDetailComposite_Error_Message
							);
							return null;
						}
				...
				eventsTable.setTitle(Messages.AutomatikoCommonEventDetailComposite_Title);
				return eventsTable;
			}
	...
	public static class AutomatikoTimerEventDefinitionDetailComposite extends TimerEventDefinitionDetailComposite {

		protected ObjectEditor scriptLanguageEditor;

		public AutomatikoTimerEventDefinitionDetailComposite(Composite parent, int style) {
			super(parent, style);
		 ...
		 * @param section
		 */
		public AutomatikoTimerEventDefinitionDetailComposite(AbstractBpmn2PropertySection section) {
			super(section);
			// TODO Auto-generated constructor stub
		}
		...
		public void createBindings(EObject be) {
			...
			scriptLanguageEditor.createControl(getAttributesParent(), Messages.AutomatikoCommonEventDetailComposite_TimerScriptLanguage);
		}
	}
}
