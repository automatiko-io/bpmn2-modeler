...
public class AutomatikoInterfaceDetailComposite extends InterfaceDetailComposite {

	public AutomatikoInterfaceDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikoInterfaceDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	...
	protected void bindReference(Composite parent, EObject object, EReference reference) {
		if ("implementationRef".equals(reference.getName()) && //$NON-NLS-1$
			...
			AutomatikoImportObjectEditor editor = new AutomatikoImportObjectEditor(this,object,reference);
