 ...
 *
 */
public class AutomatikoBusinessRuleTaskDetailComposite extends AutomatikoTaskDetailComposite {
	
	/**
	 * @param section
	 */
	public AutomatikoBusinessRuleTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoBusinessRuleTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
