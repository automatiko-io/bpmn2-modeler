...
public class AutomatikoDataInputPropertiesAdapter extends DataInputPropertiesAdapter {

	public AutomatikoDataInputPropertiesAdapter(AdapterFactory adapterFactory, DataInput object) {
    	...
    	setFeatureDescriptor(feature,
			new ItemDefinitionRefFeatureDescriptor<DataInput>(this,object,feature) {
	    		...
	    		protected void internalSet(DataInput dataInput, EStructuralFeature feature, Object value, int index) {
	    			value = AutomatikoModelUtil.getDataType(dataInput, value);
