...
public class AutomatikoSubProcessPropertiesAdapter extends ActivityPropertiesAdapter<SubProcess> {

	public AutomatikoSubProcessPropertiesAdapter(AdapterFactory adapterFactory, SubProcess object) {
