...
public class AutomatikoIoParametersListComposite extends IoParametersListComposite {

	public AutomatikoIoParametersListComposite(
		...
		tableViewer.addPostSelectionChangedListener(new ISelectionChangedListener() {
			public void selectionChanged(SelectionChangedEvent event) {
				if (removeAction!=null) {
					...
					if (AutomatikoIoParametersDetailComposite.isCustomTaskIOParameter(element))
						enable = false;
	...
	protected Object removeListItem(EObject object, EStructuralFeature feature, int index) {
		...
		while (AutomatikoIoParametersDetailComposite.isCustomTaskIOParameter(element)) {
			++index;
		...
		if (contentProvider==null) {
			contentProvider = new ListCompositeContentProvider(this, object, feature, list) {
				...
				public Object[] getElements(Object inputElement) {
					...
					if (med!=null) {
						if (AutomatikoIoParametersListComposite.this.isInput)
