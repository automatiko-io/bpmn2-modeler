 ...
 *
 */
public class AutomatikoSequenceFlowPropertySection extends SequenceFlowPropertySection {
	...
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikoSequenceFlowDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		return new AutomatikoSequenceFlowDetailComposite(parent,style);
	}
}
