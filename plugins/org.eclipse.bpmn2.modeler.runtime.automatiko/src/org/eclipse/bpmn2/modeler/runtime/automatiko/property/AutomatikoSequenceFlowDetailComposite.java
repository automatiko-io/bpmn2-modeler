 ...
 *
 */
public class AutomatikoSequenceFlowDetailComposite extends SequenceFlowDetailComposite {

	/**
	 * @param section
	 */
	public AutomatikoSequenceFlowDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoSequenceFlowDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
