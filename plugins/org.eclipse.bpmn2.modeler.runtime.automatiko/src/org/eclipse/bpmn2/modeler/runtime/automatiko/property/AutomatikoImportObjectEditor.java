...
public class AutomatikoImportObjectEditor extends ComboObjectEditor {

	private final Definitions definitions;

	
	public AutomatikoImportObjectEditor(AbstractDetailComposite parent, EObject object, EStructuralFeature feature) {
	...
	protected void buttonClicked(int buttonId) {
	    Object result = AutomatikoModelUtil.showImportDialog(object);
