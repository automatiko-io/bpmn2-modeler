...
public class AutomatikoOperationDetailComposite extends DefaultDetailComposite {

	public AutomatikoOperationDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikoOperationDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	...
	public void createBindings(EObject be) {
		...
		if (data instanceof Activity) {
			...
			if (isModelObjectEnabled(iface.eClass())) {
				...
				editor = new AutomatikoImportObjectEditor(this,iface,implementationRef);
				editor.createControl(parent,displayName);
			}
		}
