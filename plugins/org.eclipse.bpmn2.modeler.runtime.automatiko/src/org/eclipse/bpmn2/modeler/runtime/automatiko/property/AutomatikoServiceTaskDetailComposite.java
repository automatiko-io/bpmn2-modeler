 ...
 *
 */
public class AutomatikoServiceTaskDetailComposite extends AutomatikoTaskDetailComposite {

	public AutomatikoServiceTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoServiceTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
