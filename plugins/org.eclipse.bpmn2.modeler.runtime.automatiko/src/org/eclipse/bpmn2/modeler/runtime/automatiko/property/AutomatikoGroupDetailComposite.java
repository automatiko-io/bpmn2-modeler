...
public class AutomatikoGroupDetailComposite extends DefaultDetailComposite {

	public AutomatikoGroupDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoGroupDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
