 ...
 *
 */
public class AutomatikoReceiveTaskDetailComposite extends AutomatikoTaskDetailComposite {
...
//	public final static String MESSAGEID_NAME = "MessageId"; //$NON-NLS-1$
	 ...
	 * @param section
	 */
	public AutomatikoReceiveTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoReceiveTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
