...
public class AutomatikoMultiInstanceDetailComposite extends MultiInstanceLoopCharacteristicsDetailComposite {

	public AutomatikoMultiInstanceDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikoMultiInstanceDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
