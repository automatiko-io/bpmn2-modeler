 ...
 * <ul>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.automatiko.model.extension.impl.MetaDataTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.modeler.runtime.automatiko.model.extension.impl.MetaDataTypeImpl#getMetaValue <em>Meta Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetaDataTypeImpl extends EObjectImpl implements MetaDataType {
	...
	protected EClass eStaticClass() {
		return ExtensionPackage.Literals.META_DATA_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.META_DATA_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetMetaValue(MetaValueType newMetaValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExtensionPackage.META_DATA_TYPE__META_VALUE, oldMetaValue, newMetaValue);
	...
	public void setMetaValue(MetaValueType newMetaValue) {
		if (newMetaValue != metaValue) {
			...
			if (metaValue != null)
				msgs = ((InternalEObject)metaValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExtensionPackage.META_DATA_TYPE__META_VALUE, null, msgs);
			if (newMetaValue != null)
				msgs = ((InternalEObject)newMetaValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExtensionPackage.META_DATA_TYPE__META_VALUE, null, msgs);
			msgs = basicSetMetaValue(newMetaValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.META_DATA_TYPE__META_VALUE, newMetaValue, newMetaValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExtensionPackage.META_DATA_TYPE__META_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtensionPackage.META_DATA_TYPE__NAME:
				return getName();
			case ExtensionPackage.META_DATA_TYPE__META_VALUE:
				return getMetaValue();
		}
