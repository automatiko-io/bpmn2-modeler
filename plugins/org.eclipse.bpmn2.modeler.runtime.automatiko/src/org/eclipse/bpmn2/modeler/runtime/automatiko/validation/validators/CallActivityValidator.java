...
import org.eclipse.bpmn2.modeler.runtime.automatiko.validation.IDiagramProfile;
import org.eclipse.bpmn2.modeler.runtime.automatiko.validation.Messages;
...
//			}
			...
			String var = AutomatikoModelUtil.getVariableReference(calledProcessId);
			if (var!=null) {
			...
			else if (!AutomatikoModelUtil.isProcessId(calledProcessId))
