 ...
 *
 */
public class AutomatikoSendTaskDetailComposite extends AutomatikoTaskDetailComposite {
	 ...
	 * @param section
	 */
	public AutomatikoSendTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikoSendTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
