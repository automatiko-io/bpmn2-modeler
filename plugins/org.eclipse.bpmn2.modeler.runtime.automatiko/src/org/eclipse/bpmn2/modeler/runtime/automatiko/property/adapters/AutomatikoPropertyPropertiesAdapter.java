...
import org.eclipse.bpmn2.modeler.runtime.automatiko.property.Messages;
 ...
 *
 */
public class AutomatikoPropertyPropertiesAdapter extends PropertyPropertiesAdapter {

	/**
	 * @param adapterFactory
	 * @param object
	 */
	public AutomatikoPropertyPropertiesAdapter(AdapterFactory adapterFactory, Property object) {
    	...
    	setFeatureDescriptor(feature,
			new ItemDefinitionRefFeatureDescriptor<Property>(this,object,feature) {
	    		...
	    		protected void internalSet(Property property, EStructuralFeature feature, Object value, int index) {
					property.setItemSubjectRef(AutomatikoModelUtil.getDataType(property, value));
				}
		...
		setObjectDescriptor(new ObjectDescriptor<Property>(this,object) {
			...
			public String getLabel() {
				return Messages.AutomatikoDataItemsDetailComposite_LocalVariablesTitle;
			}
		});
