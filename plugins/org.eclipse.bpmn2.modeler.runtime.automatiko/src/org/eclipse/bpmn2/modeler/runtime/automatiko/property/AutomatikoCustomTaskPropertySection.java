...
public class AutomatikoCustomTaskPropertySection extends AutomatikoTaskPropertySection implements ITabbedPropertyConstants {
	...
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikoCustomTaskDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		 return new AutomatikoCustomTaskDetailComposite(parent, style);
	}
