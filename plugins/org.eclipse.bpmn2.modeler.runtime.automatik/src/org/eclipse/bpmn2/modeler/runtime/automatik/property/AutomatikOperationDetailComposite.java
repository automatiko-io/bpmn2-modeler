...
public class AutomatikOperationDetailComposite extends DefaultDetailComposite {

	public AutomatikOperationDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikOperationDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	...
	public void createBindings(EObject be) {
		...
		if (data instanceof Activity) {
			...
			if (isModelObjectEnabled(iface.eClass())) {
				...
				editor = new AutomatikImportObjectEditor(this,iface,implementationRef);
				editor.createControl(parent,displayName);
			}
		}
