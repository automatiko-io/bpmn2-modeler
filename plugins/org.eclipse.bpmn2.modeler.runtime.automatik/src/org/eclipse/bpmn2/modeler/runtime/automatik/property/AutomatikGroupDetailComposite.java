...
public class AutomatikGroupDetailComposite extends DefaultDetailComposite {

	public AutomatikGroupDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikGroupDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
