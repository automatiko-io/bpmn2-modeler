...
public class AutomatikDataOutputPropertiesAdapter extends DataOutputPropertiesAdapter {

	public AutomatikDataOutputPropertiesAdapter(AdapterFactory adapterFactory, DataOutput object) {
    	...
    	setFeatureDescriptor(feature,
			new ItemDefinitionRefFeatureDescriptor<DataOutput>(this,object,feature) {
	    		...
	    		protected void internalSet(DataOutput dataOutput, EStructuralFeature feature, Object value, int index) {
	    			value = AutomatikModelUtil.getDataType(dataOutput, value);
