 ...
 *
 */
public class AutomatikReceiveTaskDetailComposite extends AutomatikTaskDetailComposite {
...
//	public final static String MESSAGEID_NAME = "MessageId"; //$NON-NLS-1$
	 ...
	 * @param section
	 */
	public AutomatikReceiveTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikReceiveTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
