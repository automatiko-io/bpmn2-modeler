...
public class AutomatikMultiInstanceDetailComposite extends MultiInstanceLoopCharacteristicsDetailComposite {

	public AutomatikMultiInstanceDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikMultiInstanceDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
