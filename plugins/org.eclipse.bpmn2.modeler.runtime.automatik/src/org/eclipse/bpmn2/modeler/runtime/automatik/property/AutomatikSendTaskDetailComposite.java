 ...
 *
 */
public class AutomatikSendTaskDetailComposite extends AutomatikTaskDetailComposite {
	 ...
	 * @param section
	 */
	public AutomatikSendTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikSendTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
