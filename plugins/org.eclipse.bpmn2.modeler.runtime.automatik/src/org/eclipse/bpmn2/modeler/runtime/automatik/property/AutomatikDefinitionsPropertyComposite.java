 ...
 *
 */
public class AutomatikDefinitionsPropertyComposite extends DefinitionsPropertyComposite {

	/**
	 * @param section
	 */
	public AutomatikDefinitionsPropertyComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikDefinitionsPropertyComposite(Composite parent, int style) {
		super(parent, style);
	}
					...
					if (re instanceof Process) {
								...
								this,  AbstractListComposite.READ_ONLY_STYLE)
						{
							...
							protected EObject addListItem(EObject object, EStructuralFeature feature) {
								IType type = (IType) AutomatikModelUtil.showImportDialog(object);
								return AutomatikModelUtil.addImport(type, object);
							}
							...
							protected Object removeListItem(EObject object, EStructuralFeature feature, int index) {
								...
								if (importType!=null) {
									AutomatikModelUtil.removeImport(importType);
								}
