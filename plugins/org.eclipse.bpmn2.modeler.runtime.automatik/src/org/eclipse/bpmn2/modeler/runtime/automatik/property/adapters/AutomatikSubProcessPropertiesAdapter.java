...
public class AutomatikSubProcessPropertiesAdapter extends ActivityPropertiesAdapter<SubProcess> {

	public AutomatikSubProcessPropertiesAdapter(AdapterFactory adapterFactory, SubProcess object) {
