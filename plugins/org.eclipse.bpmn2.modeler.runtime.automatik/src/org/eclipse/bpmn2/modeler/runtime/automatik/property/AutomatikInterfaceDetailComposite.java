...
public class AutomatikInterfaceDetailComposite extends InterfaceDetailComposite {

	public AutomatikInterfaceDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikInterfaceDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	...
	protected void bindReference(Composite parent, EObject object, EReference reference) {
		if ("implementationRef".equals(reference.getName()) && //$NON-NLS-1$
			...
			AutomatikImportObjectEditor editor = new AutomatikImportObjectEditor(this,object,reference);
