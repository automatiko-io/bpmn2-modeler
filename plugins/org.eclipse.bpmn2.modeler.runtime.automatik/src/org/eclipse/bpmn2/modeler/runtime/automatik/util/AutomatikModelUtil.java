 ...
 *******************************************************************************/
package org.eclipse.bpmn2.modeler.runtime.automatik.util;
...
public class AutomatikModelUtil {
		...
		public ItemDefinition createItemDefinition(Definitions definitions, Import imp, IType clazz) {
			...
			if (clazz!=importedType) {
				...
				if (itemDef==null) {
					...
					AutomatikModelUtil.addImport(clazz, itemDef, false, createVariables);
...
//		}
	...
	public static boolean isProcessId(String id) {
		String var = AutomatikModelUtil.getVariableReference(id);
		if (var!=null) {
