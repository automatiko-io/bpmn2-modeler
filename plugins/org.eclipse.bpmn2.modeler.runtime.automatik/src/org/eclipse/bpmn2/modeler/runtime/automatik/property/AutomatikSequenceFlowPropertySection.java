 ...
 *
 */
public class AutomatikSequenceFlowPropertySection extends SequenceFlowPropertySection {
	...
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikSequenceFlowDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		return new AutomatikSequenceFlowDetailComposite(parent,style);
	}
}
