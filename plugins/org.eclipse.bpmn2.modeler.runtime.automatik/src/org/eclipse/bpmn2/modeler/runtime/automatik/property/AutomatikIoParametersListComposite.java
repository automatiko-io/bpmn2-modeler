...
public class AutomatikIoParametersListComposite extends IoParametersListComposite {

	public AutomatikIoParametersListComposite(
		...
		tableViewer.addPostSelectionChangedListener(new ISelectionChangedListener() {
			public void selectionChanged(SelectionChangedEvent event) {
				if (removeAction!=null) {
					...
					if (AutomatikIoParametersDetailComposite.isCustomTaskIOParameter(element))
						enable = false;
	...
	protected Object removeListItem(EObject object, EStructuralFeature feature, int index) {
		...
		while (AutomatikIoParametersDetailComposite.isCustomTaskIOParameter(element)) {
			++index;
		...
		if (contentProvider==null) {
			contentProvider = new ListCompositeContentProvider(this, object, feature, list) {
				...
				public Object[] getElements(Object inputElement) {
					...
					if (med!=null) {
						if (AutomatikIoParametersListComposite.this.isInput)
