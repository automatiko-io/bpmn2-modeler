...
public class AutomatikmportTypeDetailComposite extends DefaultDetailComposite {

	public AutomatikmportTypeDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikmportTypeDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
