 ...
 *
 */
public class AutomatikActivityDetailComposite extends ActivityDetailComposite {
	
	/**
	 * @param section
	 */
	public AutomatikActivityDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikActivityDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
