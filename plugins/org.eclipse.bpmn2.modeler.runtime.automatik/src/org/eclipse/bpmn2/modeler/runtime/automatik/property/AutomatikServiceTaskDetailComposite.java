 ...
 *
 */
public class AutomatikServiceTaskDetailComposite extends AutomatikTaskDetailComposite {

	public AutomatikServiceTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikServiceTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
