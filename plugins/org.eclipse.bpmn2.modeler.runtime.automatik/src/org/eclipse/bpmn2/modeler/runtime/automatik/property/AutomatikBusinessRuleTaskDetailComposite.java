 ...
 *
 */
public class AutomatikBusinessRuleTaskDetailComposite extends AutomatikTaskDetailComposite {
	
	/**
	 * @param section
	 */
	public AutomatikBusinessRuleTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikBusinessRuleTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
