...
public class AutomatikCustomTaskPropertySection extends AutomatikTaskPropertySection implements ITabbedPropertyConstants {
	...
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikCustomTaskDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		 return new AutomatikCustomTaskDetailComposite(parent, style);
	}
