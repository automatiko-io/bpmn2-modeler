...
public class AutomatikGatewayDetailComposite extends GatewayDetailComposite {

	public AutomatikGatewayDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikGatewayDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
