 ...
 *
 */
public class AutomatikTaskDetailComposite extends AutomatikActivityDetailComposite {
	...
	class DataInputOutputEditor extends ReadonlyTextObjectEditor {
		...
		public DataInputOutputEditor(Task task, ItemAwareElement parameter) {
			super (AutomatikTaskDetailComposite.this, parameter,
		...
		protected void buttonClicked(int buttonId) {
			...
			IPropertiesCompositeFactory factory = new DefaultPropertiesCompositeFactory() {
				...
				public AbstractDetailComposite createDetailComposite(Class eClass, Composite parent, TargetRuntime targetRuntime, int style) {
					AutomatikDataAssociationDetailComposite composite = new AutomatikDataAssociationDetailComposite(parent, SWT.NONE);
	 ...
	 * @param section
	 */
	public AutomatikTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
