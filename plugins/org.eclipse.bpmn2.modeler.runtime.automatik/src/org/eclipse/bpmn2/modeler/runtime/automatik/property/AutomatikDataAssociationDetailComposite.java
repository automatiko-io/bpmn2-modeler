 ...
 *
 */
public class AutomatikDataAssociationDetailComposite extends DataAssociationDetailComposite {

	/**
	 * @param section
	 */
	public AutomatikDataAssociationDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
	 ...
	 * @param style
	 */
	public AutomatikDataAssociationDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
	...
	public void createBindings(EObject be) {
		...
		if (adapter!=null) {
			...
			if (AutomatikIoParametersDetailComposite.isCustomTaskIOParameter((ItemAwareElement)be)) {
