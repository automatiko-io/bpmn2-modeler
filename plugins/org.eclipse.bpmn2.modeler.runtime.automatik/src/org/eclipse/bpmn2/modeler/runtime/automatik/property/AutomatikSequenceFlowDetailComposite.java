 ...
 *
 */
public class AutomatikSequenceFlowDetailComposite extends SequenceFlowDetailComposite {

	/**
	 * @param section
	 */
	public AutomatikSequenceFlowDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikSequenceFlowDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
