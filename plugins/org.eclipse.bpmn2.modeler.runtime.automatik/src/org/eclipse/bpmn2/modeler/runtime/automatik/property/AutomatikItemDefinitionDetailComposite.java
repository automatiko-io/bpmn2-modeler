...
public class AutomatikItemDefinitionDetailComposite extends
		ItemDefinitionDetailComposite {

	public AutomatikItemDefinitionDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikItemDefinitionDetailComposite(
	...
	protected void bindReference(Composite parent, EObject object, EReference reference) {
		if ("structureRef".equals(reference.getName()) && //$NON-NLS-1$
			...
			if (def.getItemKind().equals(ItemKind.INFORMATION)) {
				AutomatikItemDefinitionStructureEditor editor = new AutomatikItemDefinitionStructureEditor(this,object,reference);
