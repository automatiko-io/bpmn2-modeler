 ...
 *
 */
public class AutomatikCommonEventDetailComposite extends CommonEventDetailComposite {

	/**
	 * @param parent
	 * @param style
	 */
	public AutomatikCommonEventDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
	 ...
	 * @param section
	 */
	public AutomatikCommonEventDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
