 ...
 */
public class AutomatikExpressionDetailComposite extends ExpressionDetailComposite {

	/**
	 * @param parent
	 * @param style
	 */
	public AutomatikExpressionDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
	 ...
	 * @param section
	 */
	public AutomatikExpressionDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
