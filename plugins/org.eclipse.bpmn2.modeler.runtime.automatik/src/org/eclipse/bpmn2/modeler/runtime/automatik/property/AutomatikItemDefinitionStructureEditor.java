...
public class AutomatikItemDefinitionStructureEditor extends ItemDefinitionStructureEditor {

	public AutomatikItemDefinitionStructureEditor(AbstractDetailComposite parent, EObject object, EStructuralFeature feature) {
		super(parent, object);
	}
