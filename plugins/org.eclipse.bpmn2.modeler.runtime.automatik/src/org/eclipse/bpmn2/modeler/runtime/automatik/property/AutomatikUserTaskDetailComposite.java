 ...
 *
 */
public class AutomatikUserTaskDetailComposite extends AutomatikTaskDetailComposite {

	public AutomatikUserTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikUserTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
