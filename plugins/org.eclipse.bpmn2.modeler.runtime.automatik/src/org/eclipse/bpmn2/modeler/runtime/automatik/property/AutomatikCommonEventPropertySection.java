 ...
 *
 */
public class AutomatikCommonEventPropertySection extends CommonEventPropertySection {

	@Override
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikCommonEventDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		return new AutomatikCommonEventDetailComposite(parent,style);
	}
