 ...
 *
 */
public class AutomatikScriptTaskDetailComposite extends AutomatikTaskDetailComposite {
	 ...
	 * @param section
	 */
	public AutomatikScriptTaskDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikScriptTaskDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
