 ...
 *
 */
public class AutomatikCallActivityDetailComposite extends AutomatikActivityDetailComposite {

	BooleanObjectEditor independentEditor;
	Button independentCheckbox;
	Button waitForCompletionCheckbox;
	
	public AutomatikCallActivityDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}

	public AutomatikCallActivityDetailComposite(Composite parent, int style) {
		super(parent, style);
	}
