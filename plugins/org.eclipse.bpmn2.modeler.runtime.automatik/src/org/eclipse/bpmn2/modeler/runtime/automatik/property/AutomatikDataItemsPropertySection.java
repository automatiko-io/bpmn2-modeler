 ...
 *
 */
public class AutomatikDataItemsPropertySection extends DataItemsPropertySection {

	@Override
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikDataItemsDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		return new AutomatikDataItemsDetailComposite(parent,style);
	}
