...
public class AutomatikGatewayPropertySection extends GatewayPropertySection {
	...
	protected AbstractDetailComposite createSectionRoot() {
		return new AutomatikGatewayDetailComposite(this);
	}

	@Override
	public AbstractDetailComposite createSectionRoot(Composite parent, int style) {
		return new AutomatikGatewayDetailComposite(parent,style);
	}
