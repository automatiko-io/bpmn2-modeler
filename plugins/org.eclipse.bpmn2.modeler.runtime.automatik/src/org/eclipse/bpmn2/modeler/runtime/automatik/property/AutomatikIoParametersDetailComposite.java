...
public class AutomatikIoParametersDetailComposite extends IoParametersDetailComposite {

	public AutomatikIoParametersDetailComposite(Composite parent, int style) {
		super(parent, style);
	}

	public AutomatikIoParametersDetailComposite(AbstractBpmn2PropertySection section) {
		super(section);
	}
