...
import org.eclipse.bpmn2.modeler.runtime.automatik.util.AutomatikInterfaceImportDialog;
import org.eclipse.bpmn2.modeler.runtime.automatik.util.AutomatikModelUtil;
import org.eclipse.bpmn2.modeler.runtime.automatik.util.AutomatikModelUtil.ImportHandler;
...
public class AutomatikInterfacesPropertySection extends InterfacesPropertySection {

    public AutomatikInterfacesPropertySection() {
        super();
    }
    ...
    private class AutomatikDefinedInterfaceListComposite extends DefinedInterfaceListComposite {
        ...
        protected EObject importListItem(EObject object, EStructuralFeature feature) {
        	final AutomatikInterfaceImportDialog dialog = new AutomatikInterfaceImportDialog();
        	dialog.open();
    		...
    		AutomatikModelUtil.addImport(selectedType, object, false, dialog.isCreateVariables());
